...
public class ISOUtil {
    ...
    */
    ...
    public static String formatDouble(double d, int len) {
        ...
        try {
            if (len > 3)
                prefix = org.jpos.iso.ISOUtil.padleft(prefix,len-3,' ');
            suffix = org.jpos.iso.ISOUtil.zeropad(suffix, 2);
    ...
    public static String protect (String s, char mask) {
        ...
        try {
            ...
            if (charCount == 2 ) {
                ...
                s = org.jpos.iso.ISOUtil.padright(s, len, mask);
            }
        } catch (ISOException e){
    ...
    public static String formatAmountConversionRate(double convRate) throws ISOException {
        ...
        if (x > 9)
            bds = org.jpos.iso.ISOUtil.zeropad(bds, bds.length() + x - 9);
        String ret = org.jpos.iso.ISOUtil.zeropadRight(bds, 7);
        return Math.min(9, x) + org.jpos.iso.ISOUtil.takeFirstN(ret, 7);
    }
